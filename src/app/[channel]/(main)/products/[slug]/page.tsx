  ...
  return (
    <section className="mx-auto max-w-7xl p-8">
      ...
      <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-8">
        {/* Moved Carousel outside the form */}
        ...
        {/* Form handles only the add to cart functionality */}
        <form
          className="flex flex-col pt-6 sm:col-span-1 sm:px-6 sm:pt-0 lg:col-span-3 lg:pt-16"
          action={addItem}
        >
          <div>
