...
import { Accordion, Text } from "@saleor/macaw-ui"; // Corrected import
  ...
  const accordionItems = [
    {
      value: "shipping",
      title: "Shipping",
      content: "This is a shipping short policy.",
    },
    {
      value: "refund",
      title: "Refund",
      content: "This is a refund short policy.",
    },
  ];
        ...
        <div className="flex flex-col pt-6 sm:col-span-1 sm:px-6 sm:pt-0 lg:col-span-3 lg:pt-16">
          <div>
            ...
            <div className="mt-8 px-4">
              <Accordion defaultValue="shipping" display="flex" gap={2} flexDirection="column">
